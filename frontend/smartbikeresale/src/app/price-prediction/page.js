        ...
        <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input type="number" name="year_of_purchase" id="year_of_purchase" value={formData.year_of_purchase} onChange={handleChange} placeholder="e.g., 2020" className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
            </div>

            {/* CC */}
            <div>
              <label htmlFor="cc" className="block text-sm font-medium text-gray-700 mb-1">Engine CC</label>
              <input type="number" name="cc" id="cc" value={formData.cc} onChange={handleChange} placeholder="e.g., 250" className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
            </div>

            {/* KMs Driven */}
            <div>
              <label htmlFor="kms_driven" className="block text-sm font-medium text-gray-700 mb-1">KMs Driven</label>
              <input type="number" name="kms_driven" id="kms_driven" value={formData.kms_driven} onChange={handleChange} placeholder="e.g., 15000" className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea name="description" id="description" value={formData.description} onChange={handleChange} rows="4" placeholder="e.g., Well-maintained bike with regular servicing. Minor scratches on the side." className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"></textarea>
            </div>
          </form>
